  ...
  const FloatingElements = () => {
    return (
      <>
        ...
        <FloatingElement delay={0.4} position={{ left: '15%', top: '20%' }}>
          <Logos.Kubernetes />
        </FloatingElement>

        <FloatingElement delay={0.7} position={{ left: '85%', top: '20%' }}>
          <Logos.Aws />
        </FloatingElement>
  ...
  return (
    <div className="hero">
      ...
      <div className="content">
        <h1 className="title">👋 Hello, I'm Andrew Zhuk</h1>
        <div className="description">
          I'm a Software engineer, specializing in modern web technologies and blockchain
          development.
        </div>
      </div>
    </div>
