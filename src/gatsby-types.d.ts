...
type PostBySlugQuery = { readonly mdx: { readonly body: string | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly lang: string | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null, readonly previous: { readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly lang: string | null } | null } | null, readonly next: { readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly lang: string | null } | null } | null };
